...
public class WebsocketSecurityConfiguration extends AbstractSecurityWebSocketMessageBrokerConfigurer {
    ...
    protected void configureInbound(MessageSecurityMetadataSourceRegistry messages) {
        messages
            ...
            .simpDestMatchers("/topic/pairing-requests*")
            .hasAuthority(AGENT)
            .simpSubscribeDestMatchers("/user/queue/pairing-responses*")
            .hasAuthority(AGENT)
            // Added by Hadi
            ...
            .simpDestMatchers("/topic/action-requests*")
            .hasAnyAuthority(SKILL)
            .simpSubscribeDestMatchers("/user/queue/action-requests*")
            .hasAnyAuthority(AGENT)
            // Added by Hadi
            ...
            .simpDestMatchers("/topic/action-responses*")
            .hasAnyAuthority(AGENT)
            .simpSubscribeDestMatchers("/user/queue/action-responses*")
            .hasAnyAuthority(SKILL)
