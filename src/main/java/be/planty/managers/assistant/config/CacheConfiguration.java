...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("planty-assistant-manager");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("planty-assistant-manager");
        ...
        config.getMapConfigs().put("be.planty.managers.assistant.domain.*", initializeDomainMapConfig(jHipsterProperties));
