package be.planty.managers.assistant.config.timezone;

import be.planty.managers.assistant.PlantyAssistantManagerApp;
import be.planty.managers.assistant.repository.timezone.DateTimeWrapper;
import be.planty.managers.assistant.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pam_date_time_wrapper where id=%d", fieldName, id);
    }
