...
class SkillResourceIT {
    ...
    public static Skill createEntity(EntityManager em) {
        Skill skill = new Skill().name(DEFAULT_NAME).agentSharing(DEFAULT_AGENT_SHARING);
        return skill;
    }
    ...
    public static Skill createUpdatedEntity(EntityManager em) {
        Skill skill = new Skill().name(UPDATED_NAME).agentSharing(UPDATED_AGENT_SHARING);
        return skill;
    }
    ...
    void putExistingSkill() throws Exception {
        ...
        updatedSkill.name(UPDATED_NAME).agentSharing(UPDATED_AGENT_SHARING);
    ...
    void partialUpdateSkillWithPatch() throws Exception {
        ...
        partialUpdatedSkill.agentSharing(UPDATED_AGENT_SHARING);
    ...
    void fullUpdateSkillWithPatch() throws Exception {
        ...
        partialUpdatedSkill.name(UPDATED_NAME).agentSharing(UPDATED_AGENT_SHARING);
